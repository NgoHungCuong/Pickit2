...
namespace PICkit2V2
{
    public class USB
    {
        ...
        [DllImport("KT_Hid_Lib.dll")]
        public static extern long FindDevice(long vid, long pid);

        [DllImport("KT_Hid_Lib.dll")]
        public static extern IntPtr GetReadHandle();


        [DllImport("KT_Hid_Lib.dll")]
        public static extern IntPtr GetWriteHandle();
        ...
        {
            //thu goi ham cua minh
            //thu tim xem tim thay hay khong
            //FindDevice(p_VendorID, p_PoductID);
            /*
            if (FindDevice(p_VendorID, p_PoductID) != 0)
            {
                MessageBox.Show("Tim thay thiet bi");
            }
            else
            {
                MessageBox.Show("Khong tim thay thiet bi");
            }
            */
            //MessageBox.Show("Khong tim thay thiet bi");
            //return false;
            //ShowMsg(NULL);
            //MessageBox.Show("Ngo Hung Cuong");
            // Zero based p_index is used to identify which PICkit serial we wish to talk to
            ...
            //MessageBox.Show(HidGuid.ToString());
            ...
            */
            ...
            while(true)
            {
                MessageBox.Show(l_loop.ToString());
