...
namespace PICkit2V2
{
    public class DeviceFile
    {
        ...
        public struct DeviceFamilyParams
            ...
            public string FamilyName;           // 16 chars max
        ...
        public struct DevicePartParams
            ...
            public ushort[] ConfigMasks;        // HEX always init array to size 8
            public ushort[] ConfigBlank;        // HEX always init array to size 8
